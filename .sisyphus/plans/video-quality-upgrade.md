# Plan : Amélioration Qualité Vidéo DeepBl4nder

## Contexte

Le pipeline DeepBl4nder fonctionne end-to-end (story → storyboard → director → blender → render → post-prod) mais la qualité de sortie est au niveau "proof of concept" :
...
**Fichier principal** : `DeepBl4nder/assets/polyhaven.py` (existe, 138 lignes)
**Fichier à créer** : `DeepBl4nder/assets/characters.py`

### 1a. Client Quaternius/Mixamo pour characters rigged

Créer `DeepBl4nder/assets/characters.py` :
...
- Cache : `DeepBl4nder_cache/characters/`

### 1b. Câbler PolyHaven dans BlenderAgent

Modifier `DeepBl4nder/agents/blender.py` :
...
Ajouter à `CharacterSpec` dans `DeepBl4nder/domain/scene.py` :
- `asset_id: str = ""` — identifiant de l'asset (ex: "quaternius__animated_woman")
- `asset_source: str = ""` — "quaternius", "mixamo", "polyhaven", "custom"

**Fichiers modifiés** :
- `DeepBl4nder/assets/polyhaven.py` — pas de changement
- `DeepBl4nder/assets/characters.py` — NOUVEAU
- `DeepBl4nder/domain/scene.py` — ajouter `asset_id`, `asset_source` à `CharacterSpec`
- `DeepBl4nder/agents/blender.py` — charger assets avant génération
...
**Fichiers principaux** :
- `DeepBl4nder/skills/compositing/SKILL.md` — déjà complet (222 lignes)
- `DeepBl4nder/agents/blender.py` — modifier le prompt du LLM
...
Modifier `DeepBl4nder/plugins/rendering/ffmpeg_advanced.py` :
...
**Fichiers modifiés** :
- `DeepBl4nder/agents/blender.py` — prompt compositing
- `DeepBl4nder/plugins/rendering/ffmpeg_advanced.py` — filtres avancés

---

## Étape 3 : Script Unique par Scène (pas par plan)

**Fichier principal** : `DeepBl4nder/production/rendering.py`
...
Dans `DeepBl4nder/agents/blender.py` :
...
**Fichiers modifiés** :
- `DeepBl4nder/production/rendering.py` — mode single-script
- `DeepBl4nder/agents/blender.py` — prompt multi-shot

---

## Étape 4 : Templates d'Animation

**Fichier à créer** : `DeepBl4nder/assets/animations.py`

### 4a. Bibliothèque de templates d'animation

Créer `DeepBl4nder/assets/animations.py` :
...
**Fichiers créés** :
- `DeepBl4nder/assets/animations.py` — NOUVEAU
...
Modifier `DeepBl4nder/domain/scene.py` `RenderSpec` :
...
Modifier `DeepBl4nder/blender/bridge.py` :
...
**Fichiers modifiés** :
- `DeepBl4nder/domain/scene.py` — RenderSpec amélioré
- `DeepBl4nder/agents/blender.py` — prompt render settings
- `DeepBl4nder/blender/bridge.py` — GPU detection
...
Modifier `DeepBl4nder/codegen/validator.py` :
...
Modifier `DeepBl4nder/agents/qa.py` :
...
**Fichiers modifiés** :
- `DeepBl4nder/codegen/validator.py` — checks sémantiques
- `DeepBl4nder/agents/qa.py` — visual QA
...
|---------|--------|-------|
| `DeepBl4nder/assets/characters.py` | CRÉER | 1 |
| `DeepBl4nder/assets/animations.py` | CRÉER | 4 |
| `DeepBl4nder/domain/scene.py` | MODIFIER | 1, 5 |
| `DeepBl4nder/agents/blender.py` | MODIFIER | 1, 2, 3, 4, 5 |
| `DeepBl4nder/production/rendering.py` | MODIFIER | 3 |
| `DeepBl4nder/plugins/rendering/ffmpeg_advanced.py` | MODIFIER | 2 |
| `DeepBl4nder/blender/bridge.py` | MODIFIER | 5 |
| `DeepBl4nder/codegen/validator.py` | MODIFIER | 6 |
| `DeepBl4nder/agents/qa.py` | MODIFIER | 6 |
