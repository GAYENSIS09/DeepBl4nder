...
from DeepBl4nder.domain.media import AnimationClip, AnimationResult, Constraint, Keyframe  # noqa: F401  # exposé dans le sandbox
from DeepBl4nder.domain.scene import SceneSpec
from DeepBl4nder.skills.registry import SkillRegistry


def _animation_postcondition(_agent: BaseAgent | None, result: Any, call: Any) -> None:
