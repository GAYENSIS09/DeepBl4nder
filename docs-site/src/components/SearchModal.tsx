...
const SEARCH_DATA = [
  ...
  { title: 'LLM System', description: 'Cloud multi-provider router, model discovery, failover', href: '/docs/llm-system', category: 'Core' },
  ...
  { title: 'Skills System', description: '32 embedded skills with progressive disclosure', href: '/docs/skills', category: 'Advanced' },
  { title: 'Bridges & Engines', description: 'Blender engine bridge and integration', href: '/docs/bridges', category: 'Advanced' },
