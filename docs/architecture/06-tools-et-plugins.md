...
- `DeepBl4nder/plugins/` : `Plugin` (ABC), `PluginRegistry` (10 plugins builtins : blender,
...
- `DeepBl4nder/bridges/` : `BlenderBridge`
  — client pour le moteur Blender (bpy headless) ;
- `DeepBl4nder/agents/` : `BlenderAgent`
  — agent NOOA du moteur Blender ;
