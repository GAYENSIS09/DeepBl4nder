...
1. **Modèle LLM** : Fournisseur (Gemini, Groq, NVIDIA, OpenRouter, Cloudflare), Modèle (gemini-3.6-flash, gemini-2.5-pro, gpt-oss-120b, qwen3.6-27b, llama-3.3-70b-instruct, gemma-4-26b), Languages cibles
2. **Moteur de rendu** : Moteur (Blender EEVEE/Cycles), Qualité (Brouillon/Moyen/Haute/Ultra), Résolution (720p–4K), FPS (12–60)
